...
class igApi {
     ...
     * @param storeCookie
     */
    constructor(IgCookie = '', storeCookie = true) {
        var _a;
        ...
        this.fetchPostByMediaId = (mediaId) => __awaiter(this, void 0, void 0, function* () {
            try {
                const res = yield this.FetchIGAPI(config_1.config.instagram_media_info_url.replace('{mediaId}', mediaId.toString()));
        ...
        this.accountInfo = (userID = this.accountUserId) => __awaiter(this, void 0, void 0, function* () {
            try {
                const res = yield this.FetchIGAPI(config_1.config.instagram_user_url, `/${userID}/info/`);
        ...
        this.fetchStories = (username) => __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.FetchIGAPI(config_1.config.instagram_stories_url, `/${userID}/reel_media/`, config_1.config.iPhone);
            const graphql = res === null || res === void 0 ? void 0 : res.data;
        ...
        this._getReelsIds = (username) => __awaiter(this, void 0, void 0, function* () {
            ...
            // })
            const res = yield this.FetchIGAPI(config_1.config.instagram_graphql, '', config_1.config.iPhone, { params: (0, query_1.highlight_ids_query)(userID) });
            const graphql = res === null || res === void 0 ? void 0 : res.data;
            let items = new Array();
        ...
        this._getReels = (ids) => __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.FetchIGAPI(config_1.config.instagram_graphql, '', config_1.config.iPhone, { params: (0, query_1.highlight_media_query)(ids) });
            const graphql = res === null || res === void 0 ? void 0 : res.data;
        ...
        this.fetchUserPosts = (username, end_cursor = '') => __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this.FetchIGAPI(config_1.config.instagram_graphql, '', config_1.config.android, { params });
